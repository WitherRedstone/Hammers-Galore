...
public class ModItemTagsProvider extends ItemTagsProvider {
    ...
    protected void addTags(HolderLookup.@NotNull Provider provider) {
        ...
        tag(ModItemTags.HAMMERS)
                // ==================== 基础锤子 ====================
                .add(ModItems.WOOD_HAMMER.getKey()) // 木锤
                .add(ModItems.STONE_HAMMER.getKey()) // 石锤
                .add(ModItems.COPPER_HAMMER.getKey()) // 铜锤
                .add(ModItems.IRON_HAMMER.getKey()) // 铁锤
                .add(ModItems.GOLD_HAMMER.getKey()) //
                .add(ModItems.DIAMOND_HAMMER.getKey()) // 钻石锤
                .add(ModItems.NETHERITE_HAMMER.getKey()) // 下界合金锤

                // ==================== 特殊锤子 ====================
                .add(ModItems.NETHER_STAR_HAMMER.getKey()) // 下界之星锤
                .add(ModItems.HEART_OF_THE_SEA_HAMMER.getKey()) // 海洋之心锤
                .add(ModItems.CONDUIT_HAMMER.getKey()) // 潮涌之锤
                .add(ModItems.ENDER_PEARL_HAMMER.getKey()) // 末影锤
                .add(ModItems.MAGMA_HAMMER.getKey()) // 岩浆锤
                .add(ModItems.PISTON_HAMMER.getKey()) // 活塞锤
                .add(ModItems.GLASS_HAMMER.getKey()) // 玻璃锤
                .add(ModItems.SCULK_HAMMER.getKey()) // 幽匿锤
                .add(ModItems.EMERALD_HAMMER.getKey()); // 绿宝石锤
