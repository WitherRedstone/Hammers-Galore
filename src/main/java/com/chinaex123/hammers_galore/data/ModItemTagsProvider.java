...
public class ModItemTagsProvider extends ItemTagsProvider {
    ...
    protected void addTags(HolderLookup.@NotNull Provider provider) {
        ...
        tag(HGItemTags.HAMMERS)
                // ==================== 基础锤子 ====================
                .add(HGItems.WOOD_HAMMER.getKey()) // 木锤
                .add(HGItems.STONE_HAMMER.getKey()) // 石锤
                .add(HGItems.COPPER_HAMMER.getKey()) // 铜锤
                .add(HGItems.IRON_HAMMER.getKey()) // 铁锤
                .add(HGItems.GOLD_HAMMER.getKey()) //
                .add(HGItems.DIAMOND_HAMMER.getKey()) // 钻石锤
                .add(HGItems.NETHERITE_HAMMER.getKey()) // 下界合金锤

                // ==================== 特殊锤子 ====================
                .add(HGItems.NETHER_STAR_HAMMER.getKey()) // 下界之星锤
                .add(HGItems.HEART_OF_THE_SEA_HAMMER.getKey()) // 海洋之心锤
                .add(HGItems.CONDUIT_HAMMER.getKey()) // 潮涌之锤
                .add(HGItems.ENDER_PEARL_HAMMER.getKey()) // 末影锤
                .add(HGItems.MAGMA_HAMMER.getKey()) // 岩浆锤
                .add(HGItems.PISTON_HAMMER.getKey()) // 活塞锤
                .add(HGItems.GLASS_HAMMER.getKey()) // 玻璃锤
                .add(HGItems.SCULK_HAMMER.getKey()) // 幽匿锤
                .add(HGItems.EMERALD_HAMMER.getKey()); // 绿宝石锤
