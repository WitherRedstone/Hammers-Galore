...
public class ModRecipesProvider extends RecipeProvider {
    ...
    protected void buildRecipes() {
        ...
        // ==================== 基础工具 ====================
        // 木锤
        ShapedRecipeBuilder.shaped(itemRegistryLookup, RecipeCategory.MISC, HGItems.WOOD_HAMMER.get())
                .pattern(" BA")
                .pattern(" AB")
                .pattern("A  ")
                ...
                .save(output);
        // 石锤
        ShapedRecipeBuilder.shaped(itemRegistryLookup, RecipeCategory.MISC, HGItems.STONE_HAMMER.get())
                .pattern(" BA")
                .pattern(" AB")
                .pattern("A  ")
                .define('A', Tags.Items.RODS_WOODEN)
                ...
                .save(output);
        // 铜锤
        ShapedRecipeBuilder.shaped(itemRegistryLookup, RecipeCategory.MISC, HGItems.COPPER_HAMMER.get())
                .pattern(" BA")
                .pattern(" AB")
                .pattern("A  ")
                .define('A', Tags.Items.RODS_WOODEN)
                ...
                .save(output);
        // 铁锤
        ShapedRecipeBuilder.shaped(itemRegistryLookup, RecipeCategory.MISC, HGItems.IRON_HAMMER.get())
                .pattern(" BA")
                .pattern(" AB")
                .pattern("A  ")
                .define('A', Tags.Items.RODS_WOODEN)
                ...
                .save(output);
        // 金锤
        ShapedRecipeBuilder.shaped(itemRegistryLookup, RecipeCategory.MISC, HGItems.GOLD_HAMMER.get())
                .pattern(" BA")
                .pattern(" AB")
                .pattern("A  ")
                .define('A', Tags.Items.RODS_WOODEN)
                ...
                .save(output);
        // 钻石锤
        ShapedRecipeBuilder.shaped(itemRegistryLookup, RecipeCategory.MISC, HGItems.DIAMOND_HAMMER.get())
                .pattern(" BA")
                .pattern(" AB")
                .pattern("A  ")
                .define('A', Tags.Items.RODS_WOODEN)
        ...
        // ==================== 特殊锤子 ====================
        // 下界之星锤
        ShapedRecipeBuilder.shaped(itemRegistryLookup, RecipeCategory.MISC, HGItems.NETHER_STAR_HAMMER.get())
                .pattern("BCB")
                .pattern("CAC")
                .pattern("BCB")
                ...
                .save(output);
        // 海洋之心锤
        ShapedRecipeBuilder.shaped(itemRegistryLookup, RecipeCategory.MISC, HGItems.HEART_OF_THE_SEA_HAMMER.get())
                .pattern(" BA")
                .pattern(" AB")
                .pattern("A  ")
                .define('A', Tags.Items.RODS_WOODEN)
                ...
                .save(output);
        // 潮涌之锤
        ShapedRecipeBuilder.shaped(itemRegistryLookup, RecipeCategory.MISC, HGItems.CONDUIT_HAMMER.get())
                .pattern("BCB")
                .pattern("CAC")
                .pattern("BCB")
                ...
                .save(output);
        // 末影锤
        ShapedRecipeBuilder.shaped(itemRegistryLookup, RecipeCategory.MISC, HGItems.ENDER_PEARL_HAMMER.get())
                .pattern(" BA")
                .pattern(" AB")
                .pattern("A  ")
                .define('A', Tags.Items.RODS_WOODEN)
                ...
                .save(output);
        // 岩浆锤
        ShapedRecipeBuilder.shaped(itemRegistryLookup, RecipeCategory.MISC, HGItems.MAGMA_HAMMER.get())
                .pattern("BBB")
                .pattern("BAB")
                .pattern("BBB")
                ...
                .save(output);
        // 活塞锤
        ShapedRecipeBuilder.shaped(itemRegistryLookup, RecipeCategory.MISC, HGItems.PISTON_HAMMER.get())
                .pattern("BBB")
                .pattern("CAC")
                .pattern("BBB")
                .define('A', HGItems.IRON_HAMMER)
        ...
        // 幽匿锤
        ShapedRecipeBuilder.shaped(itemRegistryLookup, RecipeCategory.MISC, HGItems.SCULK_HAMMER.get())
                .pattern("BBB")
                .pattern("CAC")
                .pattern("BBB")
                .define('A', HGItems.IRON_HAMMER)
                ...
                .save(output);
        // 绿宝石锤
        ShapedRecipeBuilder.shaped(itemRegistryLookup, RecipeCategory.MISC, HGItems.EMERALD_HAMMER.get())
                .pattern(" BA")
                .pattern(" AB")
                .pattern("A  ")
                .define('A', Tags.Items.RODS_WOODEN)
